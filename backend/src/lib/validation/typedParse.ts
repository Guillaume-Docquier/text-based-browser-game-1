 ...
 *
 * Use this `typedParse` method instead, which accepts as input an unbranded version of the data and outputs a branded version of it, after validation.
 *
 * This is really just a schema.parse() with type safe inputs.
 *
 * @example
 * ```ts
