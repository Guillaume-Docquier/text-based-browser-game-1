...
function starSystemGenerationSettingsFromDto(
  ...
  const starSystemGenerationSettingsValidationResult = validateStarSystemGenerationSettings(settings)
  if (Result.isFailure(starSystemGenerationSettingsValidationResult)) {
    return starSystemGenerationSettingsValidationResult
  }
