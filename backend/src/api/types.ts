...
// Listings
type Listings = TrpcRouterOutput["games"]["getListings"]
export type Listing = Listings[number]

// Games router
export type GameLobby = TrpcRouterOutput["games"]["getGameLobbyById"]
export type GameStatus = GameLobby["status"]
