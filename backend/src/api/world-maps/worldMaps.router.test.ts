...
import { type CreateWorldMapSystem, WorldMapsRepository } from "#lib/db/worldMaps.repository.ts"
...
function createWorldMapSystemFixture({ gameId }: { gameId: number }): CreateWorldMapSystem {
  return {
    gameId,
...
function createMapGenerationSettings(): CreateWorldMapSystem["generationSettings"] {
  return {
