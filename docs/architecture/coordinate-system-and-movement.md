...
- `createAccount`: Creates a Star System (orbits, sectors, bodies, movement graph, etc)
...
8. Implement `StarSystemsRepository` with public methods `createAccount` and `getByGameId`.
