...
| Action          | A game action selected and submitted by a player during a Turn.                                                                                                                                    |
| Turn            | The period during which players decide which Actions to submit.                                                                                                                                    |
| Turn Resolution | The shared processing phase after a Turn ends that computes the next game state.                                                                                                                   |
| Tick            | An internal precision sub-step within Turn Resolution used to sequence events.                                                                                                                     |
