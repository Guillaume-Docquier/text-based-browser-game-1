...
| Fleet                     | A player's stationary or mobile military force at a Planet, represented by positive Strength.                                                                                                      |
| Fleet Build               | An Action and Turn Resolution Phase that creates or merges a Fleet at a targeted Planet.                                                                                                           |
| Action Target             | A server-provided candidate selected for one of an Action Definition's target slots.                                                                                                               |
