...
| Effect                    | A concrete state change compiled from a Mechanic for Turn Resolution, including its resolved targets, origin, Phase, and ordering data.                                                            |
...
| Tick                      | An internal precision sub-step within the Travel Phase used to sequence travel progress and arrivals.                                                                                              |
